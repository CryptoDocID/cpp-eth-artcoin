...
#include "genesis/tachacoinMainNetwork.cpp"
...
#include "genesis/test/tachacoinTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::tachacoinMainNetwork: return c_genesisInfoTachacoinMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::tachacoinTestNetwork: return c_genesisInfoTachacoinTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::tachacoinMainNetwork: return c_genesisStateRootTachacoinMainNetwork;
    case Network::tachacoinTestNetwork: return c_genesisStateRootTachacoinTestNetwork;
